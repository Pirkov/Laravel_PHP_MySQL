                    ...
                    <form method="post" action="{{ route('client.store') }}">
                        ...
                        <div class="col-lg-12 ms-lg-auto">
                            <div class="mt-4 mt-lg-0">
                                <h5 class="font-size-14 mb-4"><i class="mdi mdi-arrow-right text-primary me-1"></i>Введіть фамілію, ім`я, номер телефона, Email.</h5>
                                <div class="row mb-4">
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="telephone" class="form-control" id="horizontal-firstname-input">
                                    </div>
                                </div>
                                <div class="row mb-4">
