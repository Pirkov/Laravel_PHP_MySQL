    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post" action="{{ route('citie.update', $citie->id) }}">
                        @csrf
                        @method('patch')
                        <div class="col-lg-12 ms-lg-citie">
                            <div class="mt-4 mt-lg-0">
                                <h5 class="font-size-14 mb-4"><i class="mdi mdi-arrow-right text-primary me-1"></i>
                                    Ви можете змінити назву міста.</h5>


                                <div class="row mb-4">
                                    <label for="horizontal-firstname-input" class="col-sm-3 col-form-label">Місто:</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="name" value="{{ $citie->name }}" class="form-control" id="horizontal-firstname-input">
                                    </div>
                                </div>
