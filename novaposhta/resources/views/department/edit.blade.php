            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post" action="{{ route('department.update', $department->id) }}">
                        @csrf
                        @method('patch')
                        <div class="col-lg-12 ms-lg-department">
                            <div class="mt-4 mt-lg-0">
                                <h5 class="font-size-14 mb-4"><i class="mdi mdi-arrow-right text-primary me-1"></i>
                                    Ви можете змінити назву відділення.</h5>


                                <div class="row mb-4">
                                    <label for="horizontal-firstname-input" class="col-sm-3 col-form-label">Відділення:</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="name" value="{{ $department->name }}" class="form-control" id="horizontal-firstname-input">
                                    </div>
                                </div>
